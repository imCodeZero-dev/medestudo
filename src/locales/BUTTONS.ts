export const BUTTONS = {
  en: {
    ...
    BUTTON_HOME: "Home",
    BUTTON_IM_A_STUDENT: "I'm a Student",
  ...
  es: {
    ...
    BUTTON_SAVE_RESULT: "Save Result",
    BUTTON_HOME: "Home",
    BUTTON_IM_A_STUDENT: "Já sou Estudante",
    BUTTON_SHOW_DETAILS: "Show Details",
    BUTTON_CONTINUE: "Continue",
    BUTTON_FLASHCARDS: "Flashcards",
    BUTTON_GET_STARTED: "Comece Aqui",
    BUTTON_SAVE_CHANGES: "Save Changes",
    BUTTON_PREVIEW: "Preview",
    BUTTON_CHANGE_IMAGE: "Change Image",
    BUTTON_CLEAR_FILTERS: "Clear Filters",
    ...
    BUTTON_SKIP_QUESTION: "Skip Question",
    BUTTON_SEE_ALL: "See All",
    BUTTON_EXPLORE_FLASHCARDS: "Explorar Flashcards",
    BUTTON_WHY_MEDESTUDO: "Quê MedEstudo",
    BUTTON_TRY_NOW: "TESTE AGORA",
    BUTTON_MEDESTUDO_FEATURES: "Atributos do MedEstudo",
    BUTTON_LETS_BEGIN: "Vamos Começar",
    BUTTON_TESTIMONIALS: "Testimonials",
    BUTTON_OUR_AFFILIATE_PROGRAM: "NOSSO PROGRAMA DE EMBAIXADORES",
    BUTTON_JOIN_NOW: "Participar",
    BUTTON_LOGIN_WITH_GOOGLE: "Login with Google",
    BUTTON_SIGNUP_WITH_GOOGLE: "Sign-up with Google",
  },
};
